    ...
    <div className="min-h-screen bg-white text-[#333] px-6 py-8 font-manrope">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6 mb-8">
        ...
        <Card className="rounded-2xl shadow-md hover:shadow-lg transition">
          ...
          <CardContent>
            <p className="text-sm text-[#4F4F4F]">
              You’ve posted 2 ideas this week. Keep growing 🌱
            </p>
            <Button
        ...
        <Card className="rounded-2xl shadow-md hover:shadow-lg transition">
          ...
          <CardContent>
            <p className="text-sm text-[#4F4F4F]">
              You&apos;re collaborating on 3 Labs. Stay active and sync with
              your team.
            </p>
            <Button
              variant="outline"
        ...
        <Card className="rounded-2xl shadow-md hover:shadow-lg transition">
          ...
          <CardContent>
            <p className="text-sm text-[#4F4F4F]">
              You have 2 new comments and 1 lab invite.
            </p>
            <Button
              variant="outline"
              className=" cursor-pointer mt-4 w-full"
      ...
      {/* Explore Others' Seedlets Prompt */}
      <div className="mt-8 p-6 border border-dashed border-[#C9F4E5] bg-[#F9FFFD] rounded-2xl text-center shadow-sm">
      ...
      {user && (
        <Link href={`/profile/${user.data.username}`}>Profile</Link>
      )}{" "}
      <br />
      {isLoading && <Loader className="animate-spin" />}
      {user && <Link href={`/profile/edit`}>Profile Edit</Link>} <br /> */}
    </div>
  );
}
